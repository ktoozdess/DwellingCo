  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-5xl font-bold mb-8 text-center text-gray-900">About Dwelling</h1>
        <p className="text-lg leading-relaxed text-center text-gray-600 mb-8">
          Welcome to <span className="font-semibold text-gray-900">Dwelling</span>, your reliable partner in finding rental homes. 
        ...
        <p className="text-lg leading-relaxed text-center text-gray-600 mt-8">
          At Dwelling, we believe in making the process of finding your new home as simple and transparent as possible. 
